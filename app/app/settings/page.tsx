    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.2fr_1fr]">
        <GlassPanel className="walnut-card walnut-card-strong space-y-4">
          <div>
            <p className="walnut-label">Coming in Wave 5</p>
            <h2 className="mt-2 font-display text-2xl text-foreground">ENS Aggregation</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              ENS wallet linking and collateral aggregation will be available in Wave 5.
            </p>
          </div>

          <div className="walnut-alert walnut-alert-info">
            <p className="text-sm text-foreground">
              This feature is currently disabled. Wave 4 focuses on the core lending protocol with FHE token economics.
            </p>
          </div>
        </GlassPanel>
        ...
        <div className="space-y-4">
          <GlassPanel className="walnut-card walnut-card-strong walnut-kpi-card">
            <p className="walnut-label">Coming in Wave 5</p>
            <p className="walnut-value">Aggregated Collateral</p>
            <p className="walnut-meta">ENS aggregation feature</p>
          </GlassPanel>
          ...
          <GlassPanel className="walnut-card space-y-3">
            ...
            <div className="walnut-alert">
              <p className="text-sm text-muted-foreground">
                ENS wallet linking will be available in Wave 5.
              </p>
            </div>
          </GlassPanel>
        </div>
